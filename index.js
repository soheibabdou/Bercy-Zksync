...
<html><head><title>Bercy zkSync Pay</title>
<style>
...
<h1>🔺 Bercy zkSync Pay</h1>
<p>World's first <b>x402 + AC2</b> cross-border payment layer on zkSync Era Mainnet.</p>
<div>
...
app.get("/api/health", async (req, res) => {
  try {
    ...
    res.json({ status: "ok", service: "Bercy zkSync Pay", network: "zkSync Era Mainnet", protocols: ["x402", "AC2"], totalCorridors: 95 });
  }
});
...
app.listen(PORT, () => console.log("Bercy zkSync Pay running on port " + PORT));
